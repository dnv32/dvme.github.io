...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.861949795c2bf66130baad04cd143eec1840da5b86f7f971eb6d072e040498cd.js',function(){input.required=false;search();});}
